...
using System.Linq;
using Conceitos.DotNet.TrabalhandoComparable.Comparadores;
using Conceitos.DotNet.TrabalhandoComparable.Models;

namespace Conceitos.DotNet.TrabalhandoComparable
{
